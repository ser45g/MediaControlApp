...
namespace MediaControlApp.Infrastructure.DataAccess.MediaStore.Repositories
{
    public class GanreRepo : IGanreRepo
    {
        ...
        {
            var ganre = new Entities.Ganre() { Name=name, Description=description, MediaTypeId=mediaTypeId};
        ...
        public async Task<IEnumerable<Ganre>> GetAll()
        {
            ...
            return _mapper.Map<IEnumerable<Entities.Ganre>, IEnumerable<Ganre>>(authorList);
        }
        ...
        public async Task<Ganre?> GetById(Guid id)
        {
            ...
            return _mapper.Map<Entities.Ganre, Ganre>(ganre);
        }
